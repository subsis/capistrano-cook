Capistrano::Configuration.instance.load do
  ...
  namespace :gem_dependences do
    ...
    before "bundle:install", "gem_dependences:libv8"  if fix_libv8 == true
    ...
    after "deploy:setup", "gem_dependences:nokogiri" if fix_nokogiri == true
    ...
    after "deploy:setup", "gem_dependences:patron" if fix_patron == true
  end
end
